...
scene.add_sphere(o=vec2(0.5,0.5), r=0.05, m=1, v=vec2(-0.2,0.1))
scene.add_sphere(o=vec2(0.9,0.9), r=0.05, m=1, v=vec2(-0.2,-0.1))
scene.add_sphere(o=vec2(0.1,0.9), r=0.05, m=1, v=vec2(0,-0.1))
scene.add_sphere(o=vec2(0.4,0.1), r=0.05, m=1, v=vec2(0.2,0.1))
scene.add_sphere(o=vec2(0.1,0.1), r=0.05, m=1, v=vec2(0.2,-0.1))
scene.add_sphere(o=vec2(0.7,0.1), r=0.05, m=1, v=vec2(-0.2,0.1))
scene.add_sphere(o=vec2(0.5,0.7), r=0.05, m=1, v=vec2(0.2,-0.1))
scene.add_sphere(o=vec2(0.3,0.3), r=0.05, m=1, v=vec2(0.2,0.1))
...
collision = CollisionSolver(scene,0.5,0.5,0)
